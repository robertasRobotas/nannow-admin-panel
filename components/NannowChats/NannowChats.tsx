...
const NannowChats = () => {
    ...
    try {
      ...
      if (showUnreadOnly) {
        ...
        setSelectedChatId((prev) => {
          if (
            prev &&
            nextItems.some((item) => (item.chatId ?? item.id) === prev)
          ) {
            return prev;
          }
  ...
  }, [appliedSearch, itemOffset, pageSize, selectedSort, showUnreadOnly]);
                    ...
                    onClick={() => {
                      ...
                      updateNannowChatsQuery({
                        page:
                          pageCount === 0
                            ? 1
                            : Math.floor(itemOffset / pageSize) + 1,
                        sort: selectedSort,
                        q: appliedSearch,
                        id: chatId,
                        unread: showUnreadOnly,
            ...
            <div className={styles.controls}>
              ...
              <div className={styles.controlsActions}>
                ...
                <Button
                  ...
                  onClick={handleReply}
                  isDisabled={
                    isReplying || isMarkingRead || replyText.trim().length === 0
                  }
