import styles from "../OrdersSection/ordersSection.module.css";
...
const ClientOrdersSection = ({ user, onBackClick }: ClientOrdersSectionProps) => {
  ...
  return (
    <div className={styles.main}>
      <h3 className={`${styles.title} ${nunito.className}`}>Client Orders</h3>
